        ...
        <section className="px-5 xl:px-0">
            <div className="max-w-[1170px] mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 ">
                    {/* ===========img box=============== */}
                    <div className="hidden lg:block bg-orange-500 rounded-l-lg h-3/4">
              ...
              type="submit" 
              className='w-full text-[22px] leading-[30px] text-white rounded-lg px-4 py-3 bg-[#0035b9]'>
               {loading ? <HashLoader    
                         size={35}
                        color="#fff"
                        />
            ...
            <p className='mt-5 text-textColor text-center'>
              You have an account? <Link to='/login' className='text-slate-400 font-medium ml-1'>Sign In</Link>
              </p>
                        </form>
                    </div>
                </div>
